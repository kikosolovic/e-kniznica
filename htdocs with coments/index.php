...
<form method="post"> 
  <!-- POST form to find books based on author or name of the book -->
...
<br>
    <?php
        ...
        $get_search_result = $_POST["author_or_book"] ?? null; // gets book by book name or author from POST form
        ...
        // puts found books into html carousel
