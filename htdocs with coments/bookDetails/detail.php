...
<body>
    <?php
    /*
    gets book ID to fetch book from sql database

    Returns
        html with book details
    */
        ...
        $conn = new mysqli($servername, $username, $password, $database); // connection to sql database
        ...
        $bookdata = array();
        // get book from database by book ID
