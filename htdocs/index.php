  ...
  <br>
    <?php
        ...
        foreach ($result as $book) {
          echo '<div class="card pics_in_a_row" style="width: 11rem;border: none ; "><img src="'. $book['image'] . '" class="card-img-top img" alt="imagetop"><div class="card-body"><h5 class="card-title">'. $book['title'] .'</h5><p> - '. $book['fullname'] . ' <br> - '. $book['release_year'] . '</div></div>';
          if ($book['id'] % 5 == 0) {
